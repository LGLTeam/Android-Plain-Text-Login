...
public class loader extends Service {
    ...
    private native String Sw();

    private native String Se();

    private native String Ca();

    private native String Bu();

    private native String Sp();

    private native String In();

    private native String csv();

    private native String cbv();

    private native String xnxx();
    ...
    private void initFloating() {
        ...
        mExpanded.setLayoutParams(new LinearLayout.LayoutParams(550, 690));
        GradientDrawable gradientdrawable = new GradientDrawable();
        gradientdrawable.setCornerRadius(20); //Set corner
        gradientdrawable.setColor(Color.parseColor(cbv())); //Set background color
        ...
        scrollView.setBackgroundColor(Color.parseColor(csv()));
        ...
        textView.setShadowLayer(12.0f, 0.0f, 0.0f, Color.parseColor("#FFFFFFFF"));
        ...
        textView.setBackground(DCCEECC);
                ...
                switch (motionEvent.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (rawX < 10 && rawY < 10 && isViewCollapsed()) {
                            ...
                            //Toast.makeText(loader.this, Html.fromHtml(Toast()), Toast.LENGTH_SHORT).show();
                        }
                        return true;
    ...
    private void CreateMenuList() {
        ...
        for (int i = 0; i < listFT.length; i++) {
            ...
            String str = listFT[i];
            if (str.contains(Sw())) {
                addSwitch(str.replace(Sw(), ""), new InterfaceBool() {
                ...
                addCategory(str.replace(Ca(), ""));

            } else if (str.contains(Bu())) {
                addButton(str.replace(Bu(), ""), new InterfaceBtn() {
                    public void OnWrite() {
                        Changes(feature, 0);
                    }
                });
            } else if (str.contains(Sp())) {
                addSpinner(str.replace(Sp(), ""), new InterfaceInt() {
                    @Override
                    public void OnWrite(int i) {
                        Changes(feature, i);
                    }
                ...
                addTextField(str.replace(In(), ""), feature, new InterfaceInt() {
                    @Override
                    public void OnWrite(int i) {
                        Changes(feature, 0);
                    }
    ...
    private void addSwitch(String feature, final InterfaceBool sw) {
        ...
        switchR.setPadding(60, 20, 30, 20);
    ...
    private void addSeekBar(final String feature, final int prog, int max, final InterfaceInt interInt) {
        LinearLayout linearLayout = new LinearLayout(this);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        linearLayout.setPadding(60, 5, 30, 5);
        linearLayout.setOrientation(LinearLayout.VERTICAL);
        linearLayout.setGravity(17);
        linearLayout.setLayoutParams(layoutParams);
